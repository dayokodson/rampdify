...
const AddressInput: React.FC<AddressInputProps> = (props) => {
  ...
  const [address, setAddress] = useState<string>("0x22435B3c8fB160122D04E17C3865B4EeB896bF55");
  const [validatedAddress, setValidatedAddress] = useState("0x22435B3c8fB160122D04E17C3865B4EeB896bF55");
